...
namespace Robot.Tests
{
    ...
    public class RobotTest
    {
        ...
        public void CanSetUpStartPosisionForPhoenix()
        {
            ...
            Assert.AreEqual(-60, phoenix.lfl.Coxa.Angle);
            Assert.AreEqual(90, phoenix.lfl.Femur.Angle);
            Assert.AreEqual(90, phoenix.lfl.Tibia.Angle);
            ...
            Assert.AreEqual(-120, phoenix.rfl.Coxa.Angle);
            Assert.AreEqual(90, phoenix.rfl.Femur.Angle);
            Assert.AreEqual(90, phoenix.rfl.Tibia.Angle);
            ...
            Assert.AreEqual(90, phoenix.lml.Femur.Angle);
            Assert.AreEqual(90, phoenix.lml.Tibia.Angle);
            ...
            Assert.AreEqual(180, phoenix.rml.Coxa.Angle);
            Assert.AreEqual(90, phoenix.rml.Femur.Angle);
            Assert.AreEqual(90, phoenix.rml.Tibia.Angle);
            ...
            Assert.AreEqual(60, phoenix.lrl.Coxa.Angle);
            Assert.AreEqual(90, phoenix.lrl.Femur.Angle);
            Assert.AreEqual(90, phoenix.lrl.Tibia.Angle);
            ...
            Assert.AreEqual(120, phoenix.rrl.Coxa.Angle);
            Assert.AreEqual(90, phoenix.rrl.Femur.Angle);
            Assert.AreEqual(90, phoenix.rrl.Tibia.Angle);
        ...
        public void CanMoveBody1cmFovard()
        {
            ...
            Assert.AreEqual(-60 + 2.7, phoenix.lfl.Coxa.Angle);
            Assert.AreEqual(90 - 0.3 , phoenix.lfl.Femur.Angle);
            Assert.AreEqual(90 - 4.4 , phoenix.lfl.Tibia.Angle);
            Assert.AreEqual(5.7, phoenix.lfl.X);
            Assert.AreEqual(10.4, phoenix.lfl.Y);
            Assert.AreEqual(-8.9, Math.Round(phoenix.lfl.Z,1,MidpointRounding.ToEven));
      

            Assert.AreEqual(-120 - 2.7, phoenix.rfl.Coxa.Angle);
            Assert.AreEqual(90 - 0.3, phoenix.rfl.Femur.Angle);
            Assert.AreEqual(90 - 4.4, phoenix.rfl.Tibia.Angle);
            Assert.AreEqual(-5.7, phoenix.rfl.X);
            Assert.AreEqual(10.4, phoenix.rfl.Y);
            ...
            Assert.AreEqual(90, phoenix.lml.Femur.Angle);
            Assert.AreEqual(90 + 0.2, phoenix.lml.Tibia.Angle);
            Assert.AreEqual(11.4, phoenix.lml.X);
            Assert.AreEqual(10.4, phoenix.lml.Y);
            Assert.AreEqual(1.0, Math.Round(phoenix.lml.Z,1,MidpointRounding.ToEven));

            Assert.AreEqual(180 - 5.0, phoenix.rml.Coxa.Angle);
            Assert.AreEqual(90, phoenix.rml.Femur.Angle);
            Assert.AreEqual(90 + 0.2, phoenix.rml.Tibia.Angle);
            Assert.AreEqual(-11.4, phoenix.rml.X);
            Assert.AreEqual(10.4, phoenix.rml.Y);
            Assert.AreEqual(1.0, Math.Round(phoenix.rml.Z,1,MidpointRounding.ToEven));

            Assert.AreEqual(60 + 2.3, phoenix.lrl.Coxa.Angle);
            Assert.AreEqual(90 - 0.3, phoenix.lrl.Femur.Angle);
            Assert.AreEqual(90 + 5.1, phoenix.lrl.Tibia.Angle);
            Assert.AreEqual(5.7, phoenix.lrl.X);
            Assert.AreEqual(10.4, phoenix.lrl.Y);
            Assert.AreEqual(10.9, Math.Round(phoenix.lrl.Z,1,MidpointRounding.ToEven));

            Assert.AreEqual(120 - 2.3, phoenix.rrl.Coxa.Angle);
            Assert.AreEqual(90 - 0.3, phoenix.rrl.Femur.Angle);
            Assert.AreEqual(90 + 5.1, phoenix.rrl.Tibia.Angle);
            Assert.AreEqual(-5.7, phoenix.rrl.X);
            Assert.AreEqual(10.4, phoenix.rrl.Y);
        ...
        public void CanMoveBody1cmIn46Degrees()
        {
            ...
            Assert.AreEqual(-60 + -6.5, phoenix.lfl.Coxa.Angle);
            Assert.AreEqual(90 - 0.1, phoenix.lfl.Femur.Angle);
            Assert.AreEqual(90 + 2.6, phoenix.lfl.Tibia.Angle);
            ...
            Assert.AreEqual(-120 + -1.5, phoenix.rfl.Coxa.Angle);
            Assert.AreEqual(90 - 0.7, phoenix.rfl.Femur.Angle);
            Assert.AreEqual(90 + 8.1, phoenix.rfl.Tibia.Angle);
            ...
            Assert.AreEqual(90 - 0.3, phoenix.lml.Femur.Angle);
            Assert.AreEqual(90 + -4.8, phoenix.lml.Tibia.Angle);
         ...
         //   Assert.AreEqual(180 - -4.6, phoenix.rml.Coxa.Angle); //hmmm
            Assert.AreEqual(90 - 0.4, phoenix.rml.Femur.Angle);
            Assert.AreEqual(90 + 5.9, phoenix.rml.Tibia.Angle);
            ...
            Assert.AreEqual(60 + 1.9, phoenix.lrl.Coxa.Angle);
            Assert.AreEqual(90 - 0.7, phoenix.lrl.Femur.Angle);
            Assert.AreEqual(90 + -6.8, phoenix.lrl.Tibia.Angle);
            ...
            Assert.AreEqual(120 - -6.9, phoenix.rrl.Coxa.Angle);
            Assert.AreEqual(90 - 0.0, phoenix.rrl.Femur.Angle);
            Assert.AreEqual(90 + -1.6, phoenix.rrl.Tibia.Angle);
        ...
        public void CanMoveBody1cmIn45Degrees()
        {
            ...
            Assert.AreEqual(-60 + -6.6, phoenix.lfl.Coxa.Angle);
            Assert.AreEqual(90 - 0.1, phoenix.lfl.Femur.Angle);
            Assert.AreEqual(90 + 2.5, phoenix.lfl.Tibia.Angle);
            Assert.AreEqual(4.7, Math.Round(phoenix.lfl.X, 1, MidpointRounding.ToEven));
            Assert.AreEqual(10.4, Math.Round(phoenix.lfl.Y, 1, MidpointRounding.ToEven));
            Assert.AreEqual(-10.9, Math.Round(phoenix.lfl.Z, 1, MidpointRounding.ToEven));
            ...
            Assert.AreEqual(-120 + -1.6, phoenix.rfl.Coxa.Angle);
            Assert.AreEqual(90 - 0.7, phoenix.rfl.Femur.Angle);
            Assert.AreEqual(90 + 8.3, phoenix.rfl.Tibia.Angle);
            Assert.AreEqual(-6.7, Math.Round(phoenix.rfl.X, 1, MidpointRounding.ToEven));
            Assert.AreEqual(10.4, Math.Round(phoenix.rfl.Y, 1, MidpointRounding.ToEven));
            Assert.AreEqual(-10.9, Math.Round(phoenix.rfl.Z, 1, MidpointRounding.ToEven));
            ...
            Assert.AreEqual(-5.5, phoenix.lml.Coxa.Angle);
            Assert.AreEqual(90 - 0.3, phoenix.lml.Femur.Angle);
            Assert.AreEqual(90 + -4.9, phoenix.lml.Tibia.Angle);
            Assert.AreEqual(10.4, Math.Round(phoenix.lml.X, 1, MidpointRounding.ToEven));
            Assert.AreEqual(10.4, Math.Round(phoenix.lml.Y, 1, MidpointRounding.ToEven));
            Assert.AreEqual(-1.0, Math.Round(phoenix.lml.Z, 1, MidpointRounding.ToEven));
            ...
            Assert.AreEqual(-180 + 4.6, phoenix.rml.Coxa.Angle);  //hmmm
            Assert.AreEqual(90 - 0.4, phoenix.rml.Femur.Angle);
            Assert.AreEqual(90 + 6.1, phoenix.rml.Tibia.Angle);
            Assert.AreEqual(-12.4, Math.Round(phoenix.rml.X, 1, MidpointRounding.ToEven));
            Assert.AreEqual(10.4, Math.Round(phoenix.rml.Y, 1, MidpointRounding.ToEven));
            Assert.AreEqual(-1.0, Math.Round(phoenix.rml.Z, 1, MidpointRounding.ToEven));

            Assert.AreEqual(60 + 2.1, phoenix.lrl.Coxa.Angle);
            Assert.AreEqual(90 - 0.7, phoenix.lrl.Femur.Angle);
            Assert.AreEqual(90 + -6.8, phoenix.lrl.Tibia.Angle);
            Assert.AreEqual(4.7, Math.Round(phoenix.lrl.X, 1, MidpointRounding.ToEven));
            Assert.AreEqual(10.4, Math.Round(phoenix.lrl.Y, 1, MidpointRounding.ToEven));
            ...
            Assert.AreEqual(120 - -7.1, phoenix.rrl.Coxa.Angle);
            Assert.AreEqual(90 - 0.0, phoenix.rrl.Femur.Angle);
            Assert.AreEqual(90 + -1.5, phoenix.rrl.Tibia.Angle);
            Assert.AreEqual(-6.7, Math.Round(phoenix.rrl.X, 1, MidpointRounding.ToEven));
            Assert.AreEqual(10.4, Math.Round(phoenix.rrl.Y, 1, MidpointRounding.ToEven));
            Assert.AreEqual(8.9, Math.Round(phoenix.rrl.Z, 1, MidpointRounding.ToEven));
        }
        ...
        {
            //Startposision all axis to Zerro
            var lfl = RobotFactory.createLeg(Side.Left, Position.Front, 60, 1, 3, 5, 5.7, 10.4, -9.8726896031426, 4.3, -8.2);

            double degrees = 5.0;
            double direction = 1;
            Leg.CalculateNewPositionForRotation(lfl,degrees,direction,0,0);
        ...
        public void CanRotateBody5Deg()
        {
            ...
            Assert.AreEqual(-60 + 9, phoenix.lfl.Coxa.Angle);
            Assert.AreEqual(90 - 0.0, phoenix.lfl.Femur.Angle);
            Assert.AreEqual(90 +0.5, phoenix.lfl.Tibia.Angle);

            Assert.AreEqual(7.2, Math.Round(phoenix.lfl.X, 1, MidpointRounding.ToEven));
            Assert.AreEqual(10.4, Math.Round(phoenix.lfl.Y, 1, MidpointRounding.ToEven));
            Assert.AreEqual(-8.9, Math.Round(phoenix.lfl.Z, 1, MidpointRounding.ToEven));

            Assert.AreEqual(-120 - -9.1, phoenix.rfl.Coxa.Angle); //hmmm
            Assert.AreEqual(90 - 0.0, phoenix.rfl.Femur.Angle);
            Assert.AreEqual(90 + 0.2, phoenix.rfl.Tibia.Angle);
            ...
            Assert.AreEqual(90 - 0.0, phoenix.lml.Femur.Angle);
            Assert.AreEqual(90 + 0.2, phoenix.lml.Tibia.Angle);
            ...
            Assert.AreEqual(-180 + 7.8, phoenix.rml.Coxa.Angle); //hmmm
            Assert.AreEqual(90  - 0.0, phoenix.rml.Femur.Angle);
            Assert.AreEqual(90 + 0.2, phoenix.rml.Tibia.Angle);
            ...
            Assert.AreEqual(60 + 9.1, phoenix.lrl.Coxa.Angle);
            Assert.AreEqual(90 - 0.0, phoenix.lrl.Femur.Angle);
            Assert.AreEqual(90 + 0.2, phoenix.lrl.Tibia.Angle);
            ...
            Assert.AreEqual(120 - -9.0, phoenix.rrl.Coxa.Angle);
            Assert.AreEqual(90 - 0.0, phoenix.rrl.Femur.Angle);
            Assert.AreEqual(90 + 0.5, phoenix.rrl.Tibia.Angle);
